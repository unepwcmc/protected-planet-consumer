...
ActiveRecord::Schema.define(version: 20141015101012) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "model_gef_column_matches", force: true do |t|
    t.string "model_columns"
    t.string "type"
    t.text   "xls_columns"
  end

  create_table "model_gef_protected_areas", force: true do |t|
